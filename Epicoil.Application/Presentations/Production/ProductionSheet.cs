...
{
    public partial class ProductionSheet : BaseSession
    {
        ...
        public ProductionSheet(SessionInfo _session = null, ProductionHeadModel model = null)
        {
            InitializeComponent();
            epiSession = _session;
        ...
        private void dgvSerialCuttingList_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridView.Rows[e.RowIndex].Cells["ngflag"].ReadOnly == true) return;
